...
export const TemplateManager = ({ facebookTemplates, instagramTemplates, onTemplatesUpdate }: TemplateManagerProps) => {
  const [editingTemplate, setEditingTemplate] = useState<Template & { type: 'facebook' | 'instagram' } | null>(null);
          ...
          <div className="border border-border p-4 rounded-lg mb-4">
            <div className="space-y-4">
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button
                  onClick={() => handleSaveTemplate({...newTemplate, type: activeTab})}
          ...
          <div className="flex justify-between items-start mb-2">
            ...
            <div className="flex gap-2">
              ...
              <Button
                variant="ghost"
                size="sm"
                onClick={() => onDelete(template.id, template.type)}
              >
