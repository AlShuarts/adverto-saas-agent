        ...
        <div className="border rounded-lg p-4 hover:border-primary cursor-pointer transition-all">
          <div className="flex items-start space-x-3">
            <Checkbox 
              ...
              onCheckedChange={() => onPublicationTypeChange("photo")} 
            />
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Créez une publication avec du texte et des photos ou une bannière.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="border rounded-lg p-4 hover:border-primary cursor-pointer transition-all">
          <div className="flex items-start space-x-3">
            <Checkbox 
              ...
              onCheckedChange={() => onPublicationTypeChange("slideshow")} 
            />
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Créez une publication avec un diaporama dynamique de vos photos.
              </p>
            </div>
          </div>
        </div>
