      ...
      <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        <div className="text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button size="lg" className="w-full sm:w-auto" onClick={onConnectFacebook} disabled={loading}>
              <Facebook className="w-5 h-5 mr-2" />
              {profile?.facebook_page_id ? "Page Facebook connectée" : "Connecter votre page Facebook"}
            </Button>
            <Button size="lg" variant="outline" className="w-full sm:w-auto" onClick={handleInstagramConnect} disabled={loading || !onConnectInstagram}>
